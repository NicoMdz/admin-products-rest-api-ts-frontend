    ...
    <tr className="border-b ">
        ...
        <td className="p-3 text-lg text-gray-800 ">
           <div className="flex gap-2 items-center">
                <button 
                //No sirve para este ej. ya que el state unicamente se genera al presionar el boton, si alguien intenta entrar por medio de la url sin presionar el boton, no existe el state y la app crashea
